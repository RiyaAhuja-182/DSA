# [First and Last in Unosrted](https://www.geeksforgeeks.org/problems/find-index4752/1)
## Easy
...
Output: [2, 2]Explanation: 4 appears first time and last time at index 2.
Input: arr = [7, 8, 6], key = 2
Output: [-1, -1]Explanation: Since 2 does not appear in the array, we will return -1 for both the start and end indices.
Constraints:1 ≤ arr.size ≤ 1051 ≤ arr[i], key ≤&nbsp;109&nbsp;